...
[NOTE]
====
This is a preview of the upcoming version 2024.1. Please expect changes, a structurally stable version can be expected around October 2024.
====

* https://public.isaqb.org/curriculum-flex/release-candidate[**Release Candidate 2025.1** (PDF and html)]
