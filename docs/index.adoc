...
==== Upcoming Version 2023 (Currently Release Candidate)
* https://public.isaqb.org/curriculum-foundation/release-candidate/curriculum-foundation-de.pdf[Deutscher Lehrplan Release Candidate]
* https://public.isaqb.org/curriculum-foundation/release-candidate/curriculum-foundation-en.pdf[English curriculum release candidate]
